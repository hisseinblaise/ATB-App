...
export class ContactPage implements OnInit {
  ...
  get serviceType() { return this.contactForm.get('serviceType'); }
  get urgency() { return this.contactForm.get('urgency'); }
  ...
  private scrollToFirstInvalidField() {
    const firstInvalidElement = document.querySelector('.ion-invalid, .ng-invalid');
